...
<body>
  <section id="container">
    ...
    <section id="main-content">
      ...
      <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Ajouter un Administrateur</h4>
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="AjoutAdmin.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Téléphone</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <button class="btn btn-theme04" type="button" name = "annuler">Annuler</button>
                    </div>
                  </div>
                </form>
                ...
                $fileType =pathinfo($targetFilePath, PATHINFO_EXTENSION);
                  ...
                  if(in_array($fileType, $allowtypes)){
                    ...
                    {
                       $insert =$dbc->query("INSERT into utilisateur values(0,'$nom', '$prenom','$login', '$tel', 0, '$targetFilePath', '$pass',0)");
